...
extern unsigned int time_1ms_adc_500ms_chk;
extern unsigned int time_1ms_adc_500ms_chk_flag;
...
extern unsigned int time_1ms_EngRunSta_chk;
extern unsigned int time_1ms_EngRunSta_chk_flag;
...
extern unsigned int time_1ms_OBD_GndShort;
extern unsigned int time_1ms_OBD_GndShort_flag;

extern unsigned int time_1ms_OBD_BatShort;
extern unsigned int time_1ms_OBD_BatShort_flag;

extern unsigned int time_1ms_OBD_Open_Circuit;
extern unsigned int time_1ms_OBD_Open_Circuit_flag;
...
extern unsigned int time_1ms_OBD_Recovery_chk;
extern unsigned int time_1ms_OBD_Recovery_chk_flag;
...
void r_Config_TAUD0_3_interrupt(void)
{
    ...
    if(time_1ms_EngRunSta_chk_flag==1)
    {
	time_1ms_EngRunSta_chk++;
    }
    ...
    if(time_1ms_OBD_GndShort_flag==1)
    {
	time_1ms_OBD_GndShort++;
    }
    if(time_1ms_OBD_BatShort_flag==1)
    {
	time_1ms_OBD_BatShort++;
    }
    if(time_1ms_OBD_Open_Circuit_flag==1)
    {
	time_1ms_OBD_Open_Circuit++;
    }
    ...
    if(time_1ms_adc_500ms_chk_flag==1)
    {
       time_1ms_adc_500ms_chk++;
    }
    if(time_1ms_IGN_chk_flag==1)
    {
       time_1ms_IGN_chk++;
    }
    if(time_1ms_OBD_Recovery_chk_flag==1)
    {
	time_1ms_OBD_Recovery_chk++;
    }
    /* End user code. Do not edit comment generated here */
}
