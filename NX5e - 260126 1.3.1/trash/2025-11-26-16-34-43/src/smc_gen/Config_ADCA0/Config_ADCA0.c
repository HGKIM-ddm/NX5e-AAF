...
void R_Config_ADCA0_Create(void)
{
    ...
    ADCA0.VCR01.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_0 | 
                         _ADC_PHYSICAL_CHANNEL_ANI02;
    ADCA0.VCR02.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_0 | 
