...
void R_Config_ADCA0_Create(void)
{
    ...
    ADCA0.PDCTL1.UINT32 |= _ADC_ANI05_PULLDOWN_ENABLE;
    /* Set ADC0 scan group setting */
    ADCA0.SGCR1.UINT32 = _ADC_SG_SCAN_MODE_CONTINUOUS | _ADC_SG_SCAN_END_INT_ENABLE | _ADC_SG_CHANNEL_REPEAT_TIME_1;
