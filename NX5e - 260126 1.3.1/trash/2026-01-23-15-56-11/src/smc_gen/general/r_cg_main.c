...
#define ADC_UNDER_VOLTAGE_9V 1675U	 // chk 1679 ~ 1681
#define ADC_OVER_VOLTAGE_16V 3095U	 // chk 3112 ~ 3115
#define ADC_OVER_VOLTAGE_16_5V 3215U // chk 3215 ~ 3217
#define ADC_OVER_VOLTAGE_18V 3500U	 // chk 3521 ~ 3524
...
void main(void)
{
	...
	while (1)
	{
		...
		else if ((lin_bus_inactive_flag == ON) && (LIN_Short_Ok == 0))
		{
			// Lin_sleep();
		}
		else
