...
extern uint8_t w_buff[36]; // Only SX3k [30]
extern uint32_t r_buff[10]; // Only SX3k [8]
...
extern unsigned int Sleep_Stall;
extern unsigned int Last_aaf_action;
...
extern unsigned int Obd_Position_Turn;
