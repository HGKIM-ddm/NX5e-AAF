...
#if defined (__CCRH__)
#pragma interrupt r_Config_TAUJ0_channel0_interrupt(enable=false, channel=80, fpu=true, callt=false)
#elif defined (__ghs__)
#pragma ghs interrupt
#elif defined (__ICCRH850__)
#pragma type_attribute=__interrupt
...
#if defined (__CCRH__)
#pragma interrupt r_Config_TAUJ0_channel1_interrupt(enable=false, channel=81, fpu=true, callt=false)
#elif defined (__ghs__)
#pragma ghs interrupt
#elif defined (__ICCRH850__)
#pragma type_attribute=__interrupt
