...
void R_Config_ADCA0_Create(void)
{
    ...
    ADCA0.VCR00.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | 
                         _ADC_PHYSICAL_CHANNEL_ANI06;
    ADCA0.VCR01.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | 
                         _ADC_PHYSICAL_CHANNEL_ANI00;
    ADCA0.VCR02.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | 
                         _ADC_PHYSICAL_CHANNEL_ANI01;
    ADCA0.VCR03.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | 
                         _ADC_PHYSICAL_CHANNEL_ANI02;
    ADCA0.VCR04.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | 
                         _ADC_PHYSICAL_CHANNEL_ANI03;
    ADCA0.VCR05.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | 
    ...
    ADCA0.PDCTL1.UINT32 |= _ADC_ANI06_PULLDOWN_ENABLE;
    ADCA0.PDCTL1.UINT32 |= _ADC_ANI00_PULLDOWN_ENABLE;
    ADCA0.PDCTL1.UINT32 |= _ADC_ANI01_PULLDOWN_ENABLE;
    ADCA0.PDCTL1.UINT32 |= _ADC_ANI02_PULLDOWN_ENABLE;
    ADCA0.PDCTL1.UINT32 |= _ADC_ANI03_PULLDOWN_ENABLE;
    /* Set ADC0 T&H setting */
    ADCA0.THER.UINT32 = _ADC_TH4_DISABLED | _ADC_TH2_DISABLED | _ADC_TH0_DISABLED;
