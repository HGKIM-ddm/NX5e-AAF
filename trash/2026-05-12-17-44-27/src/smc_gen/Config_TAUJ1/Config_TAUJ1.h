...
Macro definitions
***********************************************************************************************************************/
#define _TAUJ1_CHANNEL0_COMPARE_VALUE                            (0x00001193UL) /* Data register for compare values */
#define _TAUJ1_CHANNEL1_COMPARE_VALUE                            (0x000008CAUL) /* Data register for compare values */
